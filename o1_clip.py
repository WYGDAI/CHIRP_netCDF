...
def clip_netcdf(var, year, shapefile_path, output_path, long_i=(-180), long_e=180, lat_i=(-50), lat_e=50):
    ...
    nc_file_name = f"chirps-v2.0.{year}.days_p05.nc"  # TO BE ADJUSTED
    ...
    mask = ws_pol_mask.mask(input_nc.isel(time=0), lat_name='latitude', lon_name='longitude')  # TO BE ADJUSTED
